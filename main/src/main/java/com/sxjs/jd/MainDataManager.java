...
public class MainDataManager extends BaseDataManager {
     ...
     * @return Disposable
     */
    public Disposable getChangePasswordData(Map<String, String> mapHeaders, Map<String, Object> mapParameters, DisposableObserver<ResponseBody> consumer) {
        return changeIOToMainThread(getService(BaseApiService.class).executePostHeader
                (KPI_ROOT_URL + SYSTEM_DIR_BASE, mapParameters, mapHeaders), consumer);
     ...
     * @return Disposable
     */
    public Disposable getHomePageData(Map<String, String> mapHeaders, Map<String, Object> mapParameters, DisposableObserver<ResponseBody> consumer) {
        return changeIOToMainThread(getService(BaseApiService.class).executePostHeader
     ...
     * @return Disposable
     */
    public Disposable getNationExamNewsListData(Map<String, String> mapHeaders, Map<String, Object> mapParameters, DisposableObserver<ResponseBody> consumer) {
        return changeIOToMainThread(getService(BaseApiService.class).executePostHeader
                (KPI_ROOT_URL + MESSAGE_DIR, mapParameters, mapHeaders), consumer);
     ...
     * @return Disposable
     */
    public Disposable getNewsItemPageDetailsData(Map<String, String> mapHeaders, Map<String, Object> mapParameters, DisposableObserver<ResponseBody> consumer) {
        return changeIOToMainThread(getService(BaseApiService.class).executePostHeader
                (KPI_ROOT_URL + MESSAGE_DIR, mapParameters, mapHeaders), consumer);
     ...
     * @return Disposable
     */
    public Disposable getChangeUserAuthenticationData(Map<String, String> mapHeaders, Map<String, Object> mapParameters, DisposableObserver<ResponseBody> consumer) {
        return changeIOToMainThread(getService(BaseApiService.class).executePostHeader
                (KPI_ROOT_URL + SYSTEM_DIR_BASE, mapParameters, mapHeaders), consumer);
    }
