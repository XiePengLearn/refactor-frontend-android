...
//        });
        ...
        helper.setText(R.id.tv_time, TimeUtils.getFriendlyTimeSpanByNow(info.getDATE()));
        ...
        helper.getView(R.id.ll_newsContainer).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(mContext, HomeWebViewActivity.class);
        ...
        if (!StringUtils.isEmpty(info.getIMAGE_URI())) {
