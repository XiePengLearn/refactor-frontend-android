 ...
 */
public class AbnormalPresenter extends BasePresenter implements AbnormalContract.Presenter {
    private              MainDataManager       mDataManager;
    private              AbnormalContract.View mContractView;
    private static final String                TAG = "ChangeAuthenticationPresenter";

    @Inject
    public AbnormalPresenter(MainDataManager mDataManager, AbnormalContract.View view) {
