 ...
 * @Description: 垂直滚动的的textview
 */
public class TextViewScrollVertical extends TextSwitcher implements ViewSwitcher.ViewFactory {
    ...
    public TextViewScrollVertical(Context context) {
        this(context, null);
        mContext = context;
    }

    public TextViewScrollVertical(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
